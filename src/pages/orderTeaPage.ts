import { CounterCup } from "interfaces/counterCupInterface.js";
import { Order } from "../interfaces/order.js";
import { Price } from "interfaces/priceInterface.js";

export class OrderTeaPage extends Order{
  counterCup: CounterCup = {
    small: 0,
    middle: 0,
    big: 0,
    smallOp: 0,
  ...
  constructor(
    ...
    this.linkDataToBtns(dataPriceCup, output, priceOp);
  ...
  render(): string {
    ...
    <main class="main">
      ...
      <div class="main-content">
        ...
        <div class="cup-size">
          <img class="img-big img" src="src/assets/order/big.svg" data-price-cup='big' alt="">
